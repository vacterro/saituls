...
every shipped feature, LIMISAW, optional agent menus, dependencies, removal and
developer checks. Start there; this folder holds narrower technical references.
...
| `LIMISAW.cs` / `LIMISAW.exe` | Codex-limit monitor source and ready-to-run binary |
...
| `problip/` | Separate optional sound monitor |
